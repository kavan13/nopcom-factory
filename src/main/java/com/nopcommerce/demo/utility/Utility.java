...
public class Utility extends ManageDriver {
    ...
    public String selectGetTextFromAlert() {
        Alert alert = driver.switchTo().alert();
...
//new
    ...
    public boolean verifyIfGetTextOfElementIsMatchedWithExpectedTextOfElement(WebElement element, String textToBeVerified){
        String actualText = getTextFromElement(element).trim();
    ...
    public void mouseHoverToElementAndClickOnVisibleTextOption(WebElement element, String visibleText) {
        Actions actions = new Actions(driver);
        String value = element.getText().trim();
        actions.moveToElement(element).toString().contains(value);
    }
    //wait method
